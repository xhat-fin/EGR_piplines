...
address_info = PipeLineEGRbyPeriod(address_api_url, 'address_info.json')
...
# запускаем шарманку
address_info.get_info_by_periods(start_date=start_date, end_date=end_date, day_delta=180, default_date=default_date)
